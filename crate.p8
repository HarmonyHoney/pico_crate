...
tiled_room = {
    ",walk (with arrow keys)",
    ",jump (with z key)",
    ",push me",
    ",pickup (with x key)",
    ",toss n cross",
    ",drop (down arrow)",
    ",push bridge",
    ",jump n grab",
    ",up up up",
    ",stack it up",
    ",spike long jump",
    ",throw n dodge",
    ",toss three",
    ",spike stack",
    ",cross n stack",
    ",spike stairs",
    ",throw dodge climb",
    ",down the boot",
    ",number 2",
    ",the final challenge",
}
...
class_wall = {
    ...
    update = function(this)
        ...
        this.is_up = mget(x, y - 1) != 16
        this.is_down = mget(x, y + 1) != 16
        this.is_left = mget(x - 1, y) != 16
        this.is_right = mget(x + 1, y) != 16
...

__label__
...
__gff__

